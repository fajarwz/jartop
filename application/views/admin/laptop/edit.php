        ...
        <div class="card col-6">
          ...
          <div class="card-body">
            ...
            <?php foreach($laptop as $lp) : ?>
              ...
              <input type="hidden" name="id" value="<?php echo $lp->id ?>">

                <div class="form-group required">
                  <label for="merk" class="control-label">Merk</label>
                  <input type="text" class="form-control" id="merk" name="merk" value="<?php echo $lp->merk ?>" autofocus>
                  <?php echo form_error('merk', '<div class="text-small text-danger">', '</div>') ?>
                </div>

                <div class="form-group required">
                  <label for="processor" class="control-label">Processor</label>
                  <input type="text" class="form-control" id="processor" name="processor" value="<?php echo $lp->processor ?>">
                  <?php echo form_error('processor', '<div class="text-small text-danger">', '</div>') ?>
                </div>

                <div class="form-group required">
                  <label for="storage" class="control-label">Storage</label>
                  <input type="text" class="form-control" id="storage" name="storage" value="<?php echo $lp->storage ?>">
                  <?php echo form_error('storage', '<div class="text-small text-danger">', '</div>') ?>
                </div>

                <div class="form-group required">
                  <label for="ram" class="control-label">RAM</label>
                  <input type="text" class="form-control" id="ram" name="ram" value="<?php echo $lp->ram ?>">
                  <?php echo form_error('ram', '<div class="text-small text-danger">', '</div>') ?>
                </div>

                <div class="form-group required">
                  <label for="vga" class="control-label">VGA</label>
                  <input type="text" class="form-control" id="vga" name="vga" value="<?php echo $lp->vga ?>">
                ...
                <div class="form-group required">
                  ...
                  <input type="text" class="form-control" id="ukuran_layar" name="ukuran_layar" value="<?php echo $lp->ukuran_layar ?>">
                  <?php echo form_error('ukuran_layar', '<div class="text-small text-danger">', '</div>') ?>
                </div>

                <div class="form-group required">
                  <label for="os" class="control-label">OS</label>
                  <input type="text" class="form-control" id="os" name="os" value="<?php echo $lp->os ?>">
                  <?php echo form_error('os', '<div class="text-small text-danger">', '</div>') ?>
                </div>

                <div class="form-group required">
                  <label for="port_usb" class="control-label">Port USB</label>
                  <input type="number" class="form-control" id="port_usb" name="port_usb" value="<?php echo $lp->port_usb ?>">
                ...
                <div class="form-group required">
                  <label for="is_cd_rom" class="control-label">CD-ROM</label>
                    <div class="form-check">
                      <input type="radio" class="form-check-input" name="is_cd_rom" id="Ya" value="Ya" <?php ($lp->is_cd_rom === "Ya") ? "checked" : "" ?>> 
                      <label for="Ya" class="form-check-label"> Ya</label>
                    </div>
                    <div class="form-check">
                      <input type="radio" class="form-check-input" name="is_cd_rom" id="Tidak" value="Tidak" <?php ($lp->is_cd_rom === "Tidak") ? "checked" : "" ?>>
                ...
                <div class="form-group required">
                  ...
                  <select id="daya_tahan_baterai" name="daya_tahan_baterai" class="custom-select">
                    <option value="< 1 Jam" <?php echo ($lp->daya_tahan_baterai === "< 1 Jam") ? "selected" : ""?>>< 1 Jam</option>
                    <option value="1 Jam" <?php echo ($lp->daya_tahan_baterai === "1 Jam") ? "selected" : ""?>>1 Jam</option>
                    <option value="2 Jam" <?php echo ($lp->daya_tahan_baterai === "2 Jam") ? "selected" : ""?>>2 Jam</option>
                    <option value="3 Jam"  <?php echo ($lp->daya_tahan_baterai === "3 Jam") ? "selected" : ""?>>3 Jam</option>
                    <option value="> 3 Jam"  <?php echo ($lp->daya_tahan_baterai === "> 3 Jam") ? "selected" : ""?>>> 3 Jam</option>
                  </select>
                ...
                <div class="form-group required">
                  ...
                  <input type="text" class="form-control" name="harga_sewa" value="<?php echo $lp->harga_sewa ?>">
                ...
                <div class="form-group required">
                  ...
                  <select name="status" class="custom-select">
                    <option value="Tersedia" <?php echo ($lp->status == "Tersedia") ? "selected" : ""?>>Tersedia</option>
                    <option value="Tidak Tersedia" <?php echo ($lp->status == "Tidak Tersedia") ? "selected" : ""?>>Tidak Tersedia</option>
                  </select>
